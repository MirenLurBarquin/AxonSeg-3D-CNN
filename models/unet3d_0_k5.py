...
class UNet(nn.Module):
    ...
    def __init__(self, n_classes: int = 1):
        ...
        # Decode
        self.upconv3 = torch.nn.ConvTranspose3d(in_channels=init_feat * 16, out_channels=init_feat * 16, kernel_size=(5, 5, 5), stride=2, padding=2, output_padding=1, bias=False)
        self.conv_decoder3 = self._block(init_feat * 16 + init_feat * 8, init_feat * 8, init_feat * 8)
        self.upconv2 = torch.nn.ConvTranspose3d(in_channels=init_feat * 8, out_channels=init_feat * 8, kernel_size=(5, 5, 5), stride=2, padding=2, output_padding=1, bias=False)
        self.conv_decoder2 = self._block(init_feat * 8 + init_feat * 4, init_feat * 4, init_feat * 4)
        self.upconv1 = torch.nn.ConvTranspose3d(in_channels=init_feat * 4, out_channels=init_feat * 4, kernel_size=(5, 5, 5), stride=2, padding=2, output_padding=1, bias=False)
